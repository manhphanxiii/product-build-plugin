...
Chuỗi tạo ra app chạy được thật - trong folder `app/` hoặc app-dir có sẵn khi restructure tại chỗ - và ghi mọi quyết định thành artifact theo cấu trúc repo lớn.
...
Mỗi folder gốc do scaffold tạo đều có một `README.md` một dòng; cây dưới đây lược bỏ các file đó để dễ đọc.
